...
var author$project$Board$init = function (n) {
	return {
...
var author$project$Main$defaultModel = function () {
	...
	return {
		board: author$project$Board$init(particle),
		interval: 1000,
	...
	function (msg, model) {
		switch (msg.$) {
			case 'SizeSliderMsg':
				...
				var cmd = _n1.b;
				var updatedBoard = author$project$Board$init(updatedSlider.value | 0);
				return _Utils_Tuple2(
					_Utils_update(
						model,
	...
	function (board, idx, cell) {
		...
		var imageLink = function () {
			if (cell.$ === 'Dead') {
				return _List_fromArray(
					[
						elm$html$Html$Attributes$src('static/image/null.png')
					]);
			} else {
				return _List_fromArray(
					[
						elm$html$Html$Attributes$src('https://avatars0.githubusercontent.com/u/4686622?s=400&v=4')
					]);
			}
		}();
